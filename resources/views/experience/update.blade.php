@extends('layouts.app')
@section('title',  'Кабинет соискателя - Редактирование места работы')
@section('description', 'Редактирование места работы')
            ...
            <div class="container mx-auto">
                ...
                <div class="w-full flex flex-col gap-3 mt-3 lg:gap-6 lg:mt-6">
                    <div class=" bg-white rounded-lg shadow-lg py-5 px-5 lg:py-10 lg:px-10">
                        <h2 class="font-semibold text-lg md:text-2xl/6">Редактирование места работы</h2>
                            ...
                            <div class="mt-2 lg:mt-4 flex flex-col lg:flex-row gap-3 lg:gap-10">
                                <div class="w-full lg:w-1/2 flex flex-col gap-4 mt-2">
                                    <div class="flex flex-col md:flex-row gap-1 md:gap-2">
                                        <label class="w-full md:w-3/8 text-base md:text-lg">Должность <sup class="text-red-500">*</sup></label>
                                        <div class="w-full md:w-5/8">
                                            <input type="text" name="position" class="block w-full py-1 bg-transparent border-b border-[#cccccc]
                                            appearance-none focus:outline-none focus:ring-0 peer" placeholder="Должность" value="{{ $experience->position }}" />
                                    ...
                                    <div class="flex flex-col md:flex-row gap-1 md:gap-2">
                                        ...
                                        <div class="w-full md:w-5/8">
                                            ...
                                            appearance-none focus:outline-none focus:ring-0 peer" placeholder="Москва" value="{{ $experience->city }}" />
                                            @if ($errors->has('city'))
                                    ...
                                    <div class="flex flex-col md:flex-row gap-1 md:gap-2">
                                        <label class="w-full md:w-3/8 text-base md:text-lg text-blue-primary">Организация <sup class="text-red-500">*</sup></label>
                                        <div class="w-full md:w-5/8">
                                            <input type="text" name="organization" class="block w-full py-1 text-blue-primary bg-transparent border-b border-[#cccccc]
                                            appearance-none focus:outline-none focus:ring-0 peer" placeholder="Организация" value="{{ $experience->organization }}" />
                                    ...
                                    <div class="flex flex-col md:flex-row gap-1 md:gap-2">
                                        <label class="w-full md:w-3/8 text-base md:text-lg text-blue-primary">Период работы <sup class="text-red-500">*</sup></label>
                                        <div class="w-full md:w-5/8">
                                            <div class="flex flex-row gap-2">
                                                <div class="w-full md:w-1/2">
                                                    ...
                                                    appearance-none focus:outline-none focus:ring-0 peer" placeholder="гггг-мм" value="{{ $experience->period_start }}" />
                                                ...
                                                <div class="w-full md:w-1/2">
                                                    ...
                                                    appearance-none focus:outline-none focus:ring-0 peer" placeholder="гггг-мм" value="{{ $experience->period_end }}" />
                                            ...
                                            <div class="flex items-start mt-1 lg:mt-3">
                                                <label class="flex items-center cursor-pointer relative">
                                                    <input type="checkbox" name="present" class="peer h-4 w-4 cursor-pointer transition-all appearance-none rounded hover:shadow-md border border-[#cccccc] checked:bg-green-primary checked:border-green-primary" id="nv" value="1" @if($experience->present) checked @endif />
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-4 mt-2">
                                    <div class="flex flex-col gap-1 md:gap-1">
                                        <label class="w-full text-base md:text-lg text-blue-primary">Обязанности и достижения <sup class="text-red-500">*</sup></label>
                                        <div class="w-full">
                                            <textarea rows="6"  class="block w-full py-1 text-blue-primary bg-transparent border-b border-[#cccccc]
                                            appearance-none focus:outline-none focus:ring-0 peer" name="description" placeholder="Расскажите о своих обязанностях и достижениях">{{ $experience->description }}</textarea>
                                            @if ($errors->has('description'))
                                                <div class="invalid-feedback text-red-500 text-sm mt-1">{{ $errors->get('description')[0] }}</div>
                                            @endif
                                        </div>
                                    </div>
                                </div>
