@extends('layouts.app')
@section('title',  'Кабинет работодателя - Вакансии')
@section('description', 'Кабинет работодателя - Вакансии')
                ...
                <div class="flex flex-col-reverse items-start lg:flex-row justify-start gap-3 lg:gap-6 w-full">
                    <div class="w-full lg:w-2/3 bg-white  rounded-lg shadow-lg py-5 px-5 lg:py-10 lg:px-10">
                        <div class="flex flex-row justify-between gap-3">
                            ...
                            <div class="">
                                <a href="{{ route('employer.vacancy.create') }}" title="Добавить" class="inline-block grow py-0 md:py-3 px-0 md:px-12 text-green-primary md:text-white text-base md:text-lg bg-transparent md:bg-green-primary border-none md:border md:border-solid border-green-primary rounded-full  hover:border-transparent md:hover:border-green-primary-hover cursor-pointer transition duration-150 ease-in-out"><span class="hidden md:inline">Добавить</span><span class="inline md:hidden text-3xl/5 font-bold">+</span></a>
                            </div>
                        </div>
                        @if(count($vacancies))
                                            ...
                                            <div class="relative">
                                                ...
                                                <div class="action-buttons-container mb-1 absolute top-0 -right-0">
                                                    ...
                                                    <div class="action-buttons hidden flex-col gap-1 absolute top-7 bg-white">
                                                        <a href="{{ route('employer.vacancy.edit', ['vacancy' => $vacancy->id]) }}" class="block p-1 text-gray-400 hover:text-green-primary transition">
                                                        ...
                                                        <a href="#" class="block p-1 text-gray-400 hover:text-yellow-600 transition">
                                                        ...
                                                        <a href="#" class="block p-1 text-gray-400 hover:text-red-600 transition">
                                                            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
