@extends('layouts.app')
@section('title',  'Кабинет HR-менеджера - Список сообщений')
@section('description', 'Список сообщений')
        ...
        <div class="container mx-auto">
            <div class="flex flex-col-reverse items-start lg:flex-row justify-start gap-3 lg:gap-6 w-full">
                <div class="w-full lg:w-2/3 bg-white  rounded-lg shadow-lg py-5 px-5 lg:py-10 lg:px-10">
                    <h1 class="text-2xl/7 lg:text-3xl/8 font-bold">Сообщения</h1>
                                ...
                                <tbody class="text-base md:text-lg divide-y divide-gray-300">
                                    @foreach($messages as $message)
                                        ...
                                        <td class="px-4 py-3 border border-gray-300 ">
                                            <a href="{{ route('hr.message.show', ['message' => $message->id]) }}" class="text-gray-500 hover:text-yellow-600 transition">
