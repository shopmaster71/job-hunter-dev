<ul class="flex flex-row w-full flex-wrap lg:flex-col gap-5">
    ...
    <li>
        <a href="{{ route('employer.index') }}" class="group text-blue-primary flex flex-row items-center transition-all duration-300 hover:opacity-75">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="group hover:opacity-75">
            ...
            <span class="text-base lg:text-lg font-medium ml-2">Профиль работодателя</span>
        </a>
    </li>
