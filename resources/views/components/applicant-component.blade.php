    ...
    <ul class="flex flex-row w-full flex-wrap lg:flex-col gap-5">
        <li class="">
                ...
                <a href="{{ $applicant ? route('applicant.profile', ['slug' => $applicant->slug]) : '#' }}" class="group text-blue-primary flex flex-row items-center transition-all duration-300 hover:opacity-75">
        ...
        <li>
            <a href="#" class="relative group text-blue-primary flex flex-row items-center transition-all duration-300 hover:opacity-75">
                ...
                <span class="text-white flex justify-center text-xs/3 items-center w-4 h-4 bg-green-primary rounded-full absolute -top-1.5 -left-1.5">1</span>
            </a>
        </li>
        <li>
