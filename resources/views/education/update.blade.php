@extends('layouts.app')
@section('title',  'Кабинет соискателя - Редактирование учебного заведения')
@section('description', 'Редактирование учебного заведения')
            ...
            <div class="container mx-auto">
                ...
                <div class="w-full flex flex-col gap-3 mt-3 lg:gap-6 lg:mt-6">
                    <div class=" bg-white rounded-lg shadow-lg py-5 px-5 lg:py-10 lg:px-10">
                        <h2 class="font-semibold text-lg md:text-2xl/6">Редактирование учебного заведения</h2>
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-4 mt-2">
                                    <div class="flex flex-col md:flex-row gap-1 md:gap-2">
                                        ...
                                        <div class="w-full md:w-5/8">
                                            ...
                                            appearance-none focus:outline-none focus:ring-0 peer" placeholder="Название учреждения" value="{{ $education->institution }}" />
                                    ...
                                    <div class="flex flex-col md:flex-row gap-1 md:gap-2">
                                        ...
                                        <div class="w-full md:w-5/8">
                                            ...
                                            appearance-none focus:outline-none focus:ring-0 peer" placeholder="Факультет" value="{{ $education->faculty }}" />
                                        ...
                                        <div class="w-full md:w-5/8">
                                            <div class="flex flex-row gap-2">
                                                <div class="w-full md:w-1/2">
                                                    <input type="text" name="period_start" class="period block w-full py-1 bg-transparent border-b border-[#cccccc]
                                                    appearance-none focus:outline-none focus:ring-0 peer" placeholder="гггг-мм" value="{{ $education->period_start }}" />
                                                ...
                                                <div class="w-full md:w-1/2">
                                                    ...
                                                    appearance-none focus:outline-none focus:ring-0 peer" placeholder="гггг-мм" value="{{ $education->period_end }}" />
                                            ...
                                            <div class="flex items-start mt-1 lg:mt-3">
                                                <label class="flex items-center cursor-pointer relative">
                                                    <input type="checkbox" name="present" class="peer h-4 w-4 cursor-pointer transition-all appearance-none rounded hover:shadow-md border border-[#cccccc] checked:bg-green-primary checked:border-green-primary" id="nv" value="1" @if($education->present) checked @endif />
                                ...
                                <div class="w-full lg:w-1/2 flex flex-col gap-4 mt-2">
                                    <div class="flex flex-col md:flex-row gap-1 md:gap-2">
                                        ...
                                        <div class="w-full md:w-5/8">
                                            ...
                                            appearance-none focus:outline-none focus:ring-0 peer" placeholder="Москва" value="{{ $education->city }}" />
                                            @if ($errors->has('city'))
                                    ...
                                    <div class="flex flex-col md:flex-row gap-1 md:gap-2">
                                        ...
                                        <div class="w-full md:w-5/8">
                                            ...
                                            appearance-none focus:outline-none focus:ring-0 peer" placeholder="Специализация" value="{{ $education->specialization }}" />
