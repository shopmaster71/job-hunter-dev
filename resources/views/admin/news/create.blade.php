...
@section('title', 'Админпанель - Новая новость')
@section('description', 'Админпанель - Новая новость')
@section('content')
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="page-title mb-0 p-0">Новая новость</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group mb-3 col-6 mg-col-12">
                                    ...
                                    <select id="tags" name="tags[]" data-placeholder="Тэги" style="width: 100%;" multiple>
                                        @foreach($tags as $k => $v)
                                            <option value="{{ $k }}" {{ in_array($k, old('tags', [])) ? 'selected' : '' }}>{{ $v }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group mb-3 col-12">
                                    ...
                                    <textarea class="form-control" id="subheading" name="subheading" rows="3">{{ old('subheading') }}</textarea>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="upload-area" id="uploadArea" style="border: 2px dashed #ccc; border-radius: 8px; padding: 25px; text-align: center; cursor: pointer; background-color: #f9f9f9;">
                                    ...
                                    <img id="imagePreview" src="" alt="Превью" style="max-width: 100%; max-height: 300px; margin-top: 10px; display: none; border-radius: 4px;">
                                </div>
                                @if ($errors->has('image'))
...
@push('scripts')
    ...
    <script>
        // Глобальная функция для обработки загрузки изображений
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            if (uploadArea && fileInput && imagePreview) {
                console.log('✅ Элементы drag-and-drop инициализированы');
