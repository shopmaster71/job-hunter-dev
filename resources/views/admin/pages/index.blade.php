...
@section('title',  'Админпанель - Страницы')
@section('description', 'Админпанель - Страницы')
@section('content')
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="page-title mb-0 p-0">Страницы</h3>
                    ...
                    <div class="card-body">
                        <div class="d-md-flex">
                            <div class="text-end upgrade-btn">
                                <a href="{{ route('pages.create') }}" class="btn btn-success d-none d-md-inline-block text-white">Создать</a>
                            </div>
                        </div>
                        @if(count($pages))
                                ...
                                <table class="table stylish-table no-wrap">
                                    ...
                                    @foreach($pages as $page)
                                        <tr>
                                            ...
                                            <td class="align-middle">{{ $page->status ? "Не опубликована": "Опубликована" }}</td>
                                            <td class="align-middle">{{ $page->created_at }}</td>
                                            <td class="align-middle">
                                                <a href="{{ route('pages.edit', ['page' => $page->id]) }}" class="icon-bts">
                                                    <i class="me-3 far fas fa-edit fa-fw" aria-hidden="true"></i>
                                                </a>
                                                <form action="{{ route('pages.destroy', ['page' => $page->id]) }}" method="post" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
