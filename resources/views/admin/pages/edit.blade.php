...
@section('title', 'Админпанель - Редактирование страницы')
@section('description', 'Админпанель - Редактирование страницы')
@section('content')
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="page-title mb-0 p-0">Редактирование страницы {{ $page->title }}</h3>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Редактирование страницы {{ $page->title }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="form-group mb-3 md-col-8">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="title"
                                   placeholder="Название" value="{{ $page->title }}">
                                    @if ($errors->has('title'))
