...
@section('title',  'Справочник - График работы')
@section('description', 'Справочник - График работы')
@section('content')
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="page-title mb-0 p-0">График работы</h3>
                    ...
                    <div class="card-body">
                        <div class="d-md-flex">
                            <div class="text-end upgrade-btn">
                                <a href="{{ route('schedules.create') }}" class="btn btn-success d-none d-md-inline-block text-white">Создать</a>
                            </div>
                        </div>
                        @if(count($schedules))
                            <div class="table-responsive mt-5">
                                <table class="table stylish-table no-wrap">
                                    <thead>
                                        <tr>
                                            <th class="border-top-0">График работы</th>
                                    ...
                                    @foreach($schedules as $schedule)
                                        <tr>
                                            ...
                                            <td class="align-middle">{{ $schedule->created_at }}</td>
                                            <td class="align-middle">
                                                <a href="{{ route('schedules.edit', ['schedule' => $schedule->id]) }}" class="icon-bts">
