...
@section('title',  'Админпанель - Изменение категории '.$category->title)
@section('description', 'Админпанель - Изменение категории '.$category->title)
@section('content')
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="page-title mb-0 p-0">Изменение категории {{ $category->title }}</h3>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Изменение категории {{ $category->title }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
