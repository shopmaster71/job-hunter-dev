...
@section('title',  'Админпанель - Изменение тэга '.$tag->title)
@section('description', 'Админпанель - Изменение тэга '.$tag->title)
@section('content')
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="page-title mb-0 p-0">Изменение категории {{ $tag->title }}</h3>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Изменение тэга {{ $tag->title }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <form role="form" action="{{ route('tags.update', ['tag' => $tag->id]) }}" method="post">
                            ...
                            <div class="form-group mb-3 col-6 mg-col-12 ">
                                <label for="title" class="form-label">Тэг</label>
