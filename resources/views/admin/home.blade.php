...
@section('title',  'Админпанель - Главная страница')
@section('description', 'Админпанель - Главная страница')
@section('content')

        <div class="page-breadcrumb">
            <div class="row align-items-center">
                <div class="col-md-6 col-8 align-self-center">
                    <h3 class="page-title mb-0 p-0">Главная страница</h3>
        ...
        <div class="container-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive mt-5">
                                <table class="table stylish-table no-wrap">
                                    ...
                                    <tr class="active">
                                        <td><span class="round"><img src="{{ asset('assets/admin/images/users/2.jpg') }}"
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card">
                        <img class="card-img-top img-responsive" src="{{ asset('assets/admin/images/big/img1.jpg') }}" alt="Card">
                        <div class="card-body">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card">
                        <img class="card-img-top img-responsive" src="{{ asset('assets/admin/images/big/img2.jpg') }}" alt="Card">
                        <div class="card-body">
                            <ul class="list-inline d-flex align-items-center">
                                <li class="ps-0">20 May 2021</li>
                                <li class="ms-auto"><a href="javascript:void(0)" class="link">3 Comment</a></li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card">
                        <img class="card-img-top img-responsive" src="{{ asset('assets/admin/images/big/img4.jpg') }}" alt="Card">
                        <div class="card-body">
                            <ul class="list-inline d-flex align-items-center">
                                <li class="ps-0">20 May 2021</li>
                                <li class="ms-auto"><a href="javascript:void(0)" class="link">3 Comment</a></li>
