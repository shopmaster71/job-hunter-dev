                ...
                <div class="w-full flex flex-col gap-3 mt-3 lg:gap-6 lg:mt-6">
                    <div class=" bg-white rounded-lg shadow-lg py-5 px-5 lg:py-10 lg:px-10">
                        <div class="flex flex-row justify-between gap-3">
                            <h2 class="font-semibold text-lg md:text-2xl/6">Создание резюме</h2>
                        </div>
                        <div class="mt-0">
                                    ...
                                    <div class="w-full md:w-1/2 flex flex-col gap-4 mt-2">
                                        <div class="w-full">
                                            ...
                                            <div class="w-full">
                                                ...
                                                appearance-none focus:outline-none focus:ring-0 peer" placeholder="100000" value="{{ old('salary') }}" />
